#!/usr/bin/env python3
'''
Desc: Import 'wait_random' from previous python file
    written and write an async routine called wait_n
    taking in 2 int arguments: max_delay and n. You will
    spawn wait_random n times with the specified max_delay.
    wait_n should return the list of all the delays(float values)
    The delays list should be in ascending order without
    using sort() because of concurrency.
Arg: n: int, max_delay: int = 10
'''
